...
class CodeEditor(QMainWindow):
    def __init__(self):
        ...
        self.fontSize = 12  # Tamaño de fuente inicial
        self.initUI()
    ...
    def initUI(self):
        self.setWindowTitle('Zeus - Editor Code')
        ...
        self.textEdit.setFont(QFont("Courier New", self.fontSize))  # Establecer la fuente inicial
        ...
        zoomOut = QAction('Disminuir Zoom', self)
    ...
    def zoomIn(self):
        self.fontSize += 2  # Aumentar el tamaño de la fuente
        self.textEdit.setFont(QFont("Courier New", self.fontSize))  # Aplicar el nuevo tamaño de fuente

    def zoomOut(self):
        if self.fontSize > 2:  # Evitar que el tamaño de fuente sea menor que 2
            self.fontSize -= 2  # Disminuir el tamaño de la fuente
            self.textEdit.setFont(QFont("Courier New", self.fontSize))  # Aplicar el nuevo tamaño de fuente
